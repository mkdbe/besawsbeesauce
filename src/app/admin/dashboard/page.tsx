      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-stone-200">
            <p className="text-sm text-stone-500 mb-1">Current Products</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-stone-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/admin/inventory" className="text-sm text-amber-600 hover:text-amber-800">
                Manage →
              </Link>
            </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-stone-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/admin/blog" className="text-sm text-amber-600 hover:text-amber-800">
                All posts →
              </Link>
            </div>
            <div className="space-y-2">
              {posts.slice(0, 5).map((p) => (
                <div key={p.id} className="flex justify-between text-sm">
                  <Link
                    ...
                    className="text-stone-600 hover:text-stone-900 truncate max-w-[200px]"
                  >
                    {p.title}
                  </Link>
                  <span className={p.published ? 'text-green-600' : 'text-stone-400'}>
